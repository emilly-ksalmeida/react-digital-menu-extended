...
function Pedido() {
  ...
  return (
    <div className="container flex flex-col gap-4 mx-auto bg-amber-50 p-4 rounded-md">
      <div className="flex justify-between items-center w-full bg-cabecalho px-4 sm:px-8 py-4 rounded-md">
        <button 
        ...
        <h1 className="text-white font-extrabold text-[1.2rem] sm:text-[1.5rem]">Lista de Pedidos</h1>
      </div>
